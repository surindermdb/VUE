                    ...
                    <div class="filter">
                        <div class="dropdown" @click="showDropdown">
                            ...
                            <ul>
                                ...
                                <input class="multiselectOption" type="checkbox" :id="index" :value="option.value" @change="onCheck($event)">
                                <label class="optionLabel" :for="index">{{ option.text }}</label>
                                </li>
                                <li>
                            ...
                            <div class="multiselect" v-if="showColor">
                                <ul>
                                    <li v-for="(option, index) in ddTestColor.options" :key="index">
                                        <input class="multiselectOption" type="checkbox" :id="index" :value="option.value" @change="onCheckColor($event)">
                                        <label class="optionLabel" :for="index">{{ option.text }}</label>
                                    </li>
                                    <li>
                                        <div class="btn_wrapper">
                        ...
                        <div class="dropdown" @click="showSizeDropdown">
                            ...
                            <ul>
                                <li v-for="(option, index) in ddTestSize.options" :key="index">
                                    <input class="multiselectOption" type="checkbox" :id="index" :value="option.value" @change="onCheckSize($event)">
                                    <label class="optionLabel" :for="index">{{ option.text }}</label>
                                </li>
                                <li>
                                    <div class="btn_wrapper">
                        ...
                        <div class="dropdown" @click="showMaterialDropdown">
                            ...
                            <ul>
                                <li v-for="(option, index) in ddTestMaterial.options" :key="index">
                                    <input class="multiselectOption" type="checkbox" :id="index" :value="option.value" @change="onCheckMaterial($event)">
                                    <label class="optionLabel" :for="index">{{ option.text }}</label>
                                </li>
                                <li>
                                    <div class="btn_wrapper">
